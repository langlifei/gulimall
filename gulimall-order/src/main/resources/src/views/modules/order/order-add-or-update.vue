<template>
  <el-dialog
    ...
    <el-form-item label="ʹ" prop="couponId">
      <el-input v-model="dataForm.couponId" placeholder="ʹ"></el-input>
    </el-form-item>
    ...
    <el-form-item label="Ӧ" prop="payAmount">
      <el-input v-model="dataForm.payAmount" placeholder="Ӧ"></el-input>
    </el-form-item>
    ...
    <el-form-item label="֧" prop="payType">
      <el-input v-model="dataForm.payType" placeholder="֧"></el-input>
    </el-form-item>
    ...
    <el-form-item label="" prop="billType">
      <el-input v-model="dataForm.billType" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="ʡ" prop="receiverProvince">
      <el-input v-model="dataForm.receiverProvince" placeholder="ʡ"></el-input>
    </el-form-item>
    ...
    <el-form-item label="ȷ" prop="confirmStatus">
      <el-input v-model="dataForm.confirmStatus" placeholder="ȷ"></el-input>
    </el-form-item>
    <el-form-item label="ɾ" prop="deleteStatus">
      <el-input v-model="dataForm.deleteStatus" placeholder="ɾ"></el-input>
    </el-form-item>
    <el-form-item label="" prop="useIntegration">
      <el-input v-model="dataForm.useIntegration" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="֧" prop="paymentTime">
      <el-input v-model="dataForm.paymentTime" placeholder="֧"></el-input>
    </el-form-item>
    <el-form-item label="" prop="deliveryTime">
      <el-input v-model="dataForm.deliveryTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="ȷ" prop="receiveTime">
      <el-input v-model="dataForm.receiveTime" placeholder="ȷ"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          payAmount: [
            { required: true, message: 'Ӧ不能为空', trigger: 'blur' }
          ],
          freightAmount: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
          ...
          payType: [
            { required: true, message: '֧不能为空', trigger: 'blur' }
          ],
          sourceType: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
          ...
          receiverProvince: [
            { required: true, message: 'ʡ不能为空', trigger: 'blur' }
          ],
          receiverCity: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
          ...
          confirmStatus: [
            { required: true, message: 'ȷ不能为空', trigger: 'blur' }
          ],
          deleteStatus: [
            { required: true, message: 'ɾ不能为空', trigger: 'blur' }
          ],
          useIntegration: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
